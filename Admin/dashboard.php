...
<body>
    <div class="main-container">
        ...
        <div class="sidebar">
            ...
            <a href="kelola_data_user.php" class="menu-item <?= $active_page=='user'?'active':'' ?>">
                <svg viewBox="0 0 24 24"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                Kelola Data User
            </a>
            <a href="kelola_data_produk.php" class="menu-item <?= $active_page=='produk'?'active':'' ?>">
                <svg viewBox="0 0 24 24"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline><line x1="12" y1="22.08" x2="12" y2="12"></line></svg>
                Kelola Data Produk
            </a>
            <a href="kelola_data_transaksi.php" class="menu-item <?= $active_page=='transaksi'?'active':'' ?>">
            ...
            <a href="backup_data.php" class="menu-item <?= $active_page=='backup'?'active':'' ?>">
                <svg viewBox="0 0 24 24"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="17 8 12 3 7 8"></polyline><line x1="12" y1="3" x2="12" y2="15"></line></svg>
                Backup Data
            </a>
            <a href="restore_data.php" class="menu-item <?= $active_page=='restore'?'active':'' ?>">
        ...
        <div class="main-content">
            <div class="header">
                ...
                <div class="user-info">
                    ...
                    <span class="user-name"><?= htmlspecialchars($_SESSION['nama_petugas']) ?></span>
                </div>
            </div>

            <div class="welcome-text">WELCOME TO ADMIN</div>
